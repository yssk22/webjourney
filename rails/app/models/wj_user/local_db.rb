# The user whose credentials are stored in the local database.
class WjUser::LocalDB < WjUser
  include WjUser::LocalDatabaseAuth
  class RequestConfirmationError < WebJourney::ClientRequestError; end
